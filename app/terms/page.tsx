  ...
  return (
    <AppShell>
      <main id="main" className="mx-auto max-w-3xl px-5 py-10 leading-7 text-muted">
        <h1 className="font-[family-name:var(--font-serif-tc)] text-4xl text-ink">使用條款</h1>
        ...
        <p className="mt-3">
          WhatsApp 訂座由你發送予商戶。即時留位商戶在系統內顯示確認，仍以商戶回覆為最終有效。取消費用如有，由商戶自行說明。
        </p>
        <h2 className="mt-8 text-xl text-ink">商戶</h2>
        <p className="mt-3">
          商戶按確認入座支付 CPA。待確認狀態不收費。合作標籤不得買斷排序第一位。虛報空位可被下架。
        </p>
